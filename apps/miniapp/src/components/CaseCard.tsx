...
import { getCasePortfolioAsset } from '../domain/case-catalog.js';
  ...
  return (
    <article className="case-card">
      <div className="case-card__visual">
        ...
        {asset?.attribution === undefined ? null : (
          <small className="case-card__attribution">{asset.attribution}</small>
        )}
      </div>
